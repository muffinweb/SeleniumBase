...
def hyundai_scrape(trackingNumber: str):
    ...
    with SB(uc=True, agent=userAgent, proxy=proxy, incognito=True) as sb:
        ...
        sb.cdp.open("https://www.hmm21.com/e-service/general/trackNTrace/TrackNTrace.do")
        ...
        return {"benchmark_time": benchmark_time, "xhr_requests": xhr_responses, "content": page_source}
